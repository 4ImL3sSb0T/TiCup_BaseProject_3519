 ...
 *
 * 引脚参考官方例程：
 *   Motherboard_Demo/E2_encoder/E2_01_encoder_quadrature_demo
 *
 * 注意：逐飞库 encoder_quad_init 仅支持 TIM_G8 / TIM_G9。
 */
...
/* --------------------------------------------------------------------------
 * 编码器硬件配置 —— 与逐飞 E2_01_encoder_quadrature_demo 一致（正交模式）
 *   ENCODER1: TIM_G8, CH1=A26, CH2=A27  → 左轮
 *   ENCODER2: TIM_G9, CH1=B7,  CH2=B9   → 右轮
 * -------------------------------------------------------------------------- */
#define ENCODER_LEFT_TIMER              (TIM_G8)
#define ENCODER_LEFT_CH1                (TIMG8_ENCODER1_CH1_A26)
#define ENCODER_LEFT_CH2                (TIMG8_ENCODER1_CH2_A27)

#define ENCODER_RIGHT_TIMER             (TIM_G9)
#define ENCODER_RIGHT_CH1               (TIMG9_ENCODER1_CH1_B7)
#define ENCODER_RIGHT_CH2               (TIMG9_ENCODER1_CH2_B9)
...
typedef struct {
    ...
    encoder_channel1_enum channel1;             ///< A 相引脚
    encoder_channel2_enum channel2;             ///< B 相引脚
